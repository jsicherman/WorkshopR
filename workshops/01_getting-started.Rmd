...
**Week 8:** Handling big data using {data.table}\
...
Fridays from 2:00 - 3:00 PST. You can add [this](https://ubc.zoom.us/meeting/u5cufu-rrzgvEt0ys0SHUYtAi2o9gGYZDaNG/ics?icsToken=98tyKu-rrTIsGdWWtRGOR_MqA4r4M-nzmHZYj7cNhQy1MAhmWxfXP7BNa7VYKeL0) to your calendar to keep track of the meeting schedule.
...
Why should you choose R instead of other programming languages? R is known to be somewhat quirky and is not the fastest language out there, but it has a large community of data analysts and thus a huge selection of packages for easing your own analysis. It also has some of the best plotting libraries out there.
...
5.  You can subset vectors using square brackets (`[…]`)
...
```{r}
planets <- factor(c("Mercury", "Venus", "Earth", "Mars", "Jupiter", "Saturn", "Uranus", "Neptune"), ordered = TRUE)
planets
```
